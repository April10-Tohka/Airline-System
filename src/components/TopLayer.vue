...
<div class="container">
    ...
    <div class="btn-wrap">
<!--        只有首页和注册页才能看见回到首页按钮-->
        <div class="btn-home" v-show-on-route:homebtn="{showOnRoutes:['login','register'],routeName:route.name}">
            <router-link to="/">
                <svg t="1714272855561" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4309" width="20" height="30">
                    <path d="M422.63 891.821V623.712h178.74v268.109h223.424V534.342h134.054L512 132.179 65.152 534.342h134.054V891.82H422.63z" p-id="4310" ></path>
                </svg>
                <span>首页</span>
            </router-link>
        </div>
<!--        不是登录注册页就显示-->
        <ul class="account-bar" v-show-on-route:accountbar="{showOnRoutes:['login','register'],routeName:route.name}">
<!--            未登录状态显示登录注册按钮-->
            <li class="account-bar-item" v-show="!userStore.token" data-login-status="Not logged">
                <div class="account-bar-item">
                    <button class="login-button" @click="goToLogin">
                        <svg x="1716867389541" class="login-icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" p-id="2650" width="24" height="24">
                            <path d="M512 0a512 512 0 1 0 512 512A512 512 0 0 0 512 0zM213.333 832A298.667 298.667 0 0 1 512 533.333a170.667 170.667 0 1 1 170.667-170.666A170.667 170.667 0 0 1 512 533.333 298.667 298.667 0 0 1 810.667 832z"  p-id="2651"></path>
                        </svg>
                        <span style="margin-left: 5px;margin-right: 2px;font-size: 14px">请登录</span>
                    </button>
                </div>
                <div class="account-bar-item">
...
<!--            已登录状态下-->
            <li class="account-bar-item dropdown" v-show="userStore.token"  data-login-status="logged">
                <button class="login-button dropdown-toggle">
                    <img src="https://dimg04.c-ctrip.com/images/0AS1k120009l60yh36D69.jpg" class="avatar">
                    <span class="logged-title">尊敬的会员</span>
                    <svg t="1716970048735" class="arrow" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="6502" width="12" height="12">
                        <path d="M482.133333 738.133333L136.533333 392.533333c-17.066667-17.066667-17.066667-42.666667 0-59.733333 8.533333-8.533333 19.2-12.8 29.866667-12.8h689.066667c23.466667 0 42.666667 19.2 42.666666 42.666667 0 10.666667-4.266667 21.333333-12.8 29.866666L541.866667 738.133333c-17.066667 17.066667-42.666667 17.066667-59.733334 0z" fill="#666666" p-id="6503"></path>
                    </svg>
                </button>
<!--                下拉菜单-->
                <ul class="dropdown-menu">
                    <div class="dropdown-menu-panel">
                        ...
                        <div class="info-list">
                            ...
                            <a href="javascript:void(0)" class="info-list-item">我的钱包</a>
                            <div class="info-list-divider"></div>
                            <a href="javascript:void(0)" class="info-list-item" @click="logout">
                                <svg t="1716971870580" class="logout" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="7673" width="16" height="16">
                                    <path d="M985.555034 550.417767H550.374889a38.398248 38.398248 0 1 1 0-76.796496h435.180145a38.398248 38.398248 0 1 1 0 76.796496z" fill="#5A607F" p-id="7674"></path><path d="M511.976641 1023.99616a511.976641 511.976641 0 1 1 415.34105-812.762918 38.398248 38.398248 0 1 1-63.99708 45.437927 435.180145 435.180145 0 1 0 0 511.976641 38.398248 38.398248 0 1 1 63.99708 45.437927A511.976641 511.976641 0 0 1 511.976641 1023.99616z"  p-id="7675"></path>
                                </svg>
                                <span>退出登录</span>
                            </a>
                        </div>
            ...
            <li class="account-bar-item">
                <button class="order-button" @click="goToOrder">
                    <svg t="1716886927667" class="order-icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2924" width="24" height="24">
                        <path d="M626.57 198.4H396.09c-0.6 0-1.1-0.49-1.1-1.1V99.77c0-0.6 0.49-1.1 1.1-1.1h230.49c0.6 0 1.1 0.49 1.1 1.1v97.53c-0.01 0.6-0.5 1.1-1.11 1.1z" p-id="2925"></path><path d="M748.35 162.87h-90.58c-1.34 32.76-28.36 59.2-61.45 59.2h-170c-33.07 0-60.1-26.44-61.45-59.2h-90.56c-50.08 0-91.04 40.97-91.04 91.04v515.96c0 50.07 40.96 91.04 91.04 91.04h474.04c50.08 0 91.04-40.97 91.04-91.04V253.91c0-50.08-40.96-91.04-91.04-91.04zM682.1 672.79H340.56c-12.58 0-22.76-10.18-22.76-22.76s10.18-22.76 22.76-22.76H682.1c12.58 0 22.76 10.18 22.76 22.76s-10.18 22.76-22.76 22.76z m0-138.75H340.56c-12.58 0-22.76-10.18-22.76-22.76s10.18-22.76 22.76-22.76H682.1c12.58 0 22.76 10.18 22.76 22.76s-10.18 22.76-22.76 22.76z m0-138.74H340.56c-12.58 0-22.76-10.18-22.76-22.76 0-12.58 10.18-22.76 22.76-22.76H682.1c12.58 0 22.76 10.18 22.76 22.76 0 12.58-10.18 22.76-22.76 22.76z" p-id="2926"></path>
                    </svg>
                    <span>我的订单</span>
                </button>
            </li>
...
div.logo
{
    a
    {
        background: url("https://webresource.c-ctrip.com/ares2/nfes/pc-home/1.0.65/default/image/logo.png") no-repeat;
...
div.btn-wrap
{
    ...
    ul.account-bar
    {
        ...
        .account-bar-item[data-login-status="logged"]:hover
        {
            .logged-title
            {
                color: #0086f6;
...
.login-button:hover,.order-button:hover
{
    span
    {
        color: #0086f6;
