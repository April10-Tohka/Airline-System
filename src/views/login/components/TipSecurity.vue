...
<template>
<div class="tip-security">
    <i class="icon-warn">
        <svg t="1714274136236" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="7148" width="20" height="20">
    ...
    <a href="https://contents.ctrip.com/huodong/privacypolicypc/index?type=1" target="_blank" >《隐私政策》</a>
    已上线，感谢您的支持。
</div>
</template>
