...
<!--                飞机票-->
                <div class="flight-item" v-for="ticket in flightTickets" :key="ticket.flightNo">
...
onMounted(()=>{
    getFlightTickets(flight.departCity,flight.arriveCity).then(res=>{
        console.log("getFlgihtTickets返回的数据",res);
        let {data}=res.data;
        flightTickets.value=data;
    })
})
