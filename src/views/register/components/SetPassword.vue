...
onMounted(()=>{
    ...
    eventBusStore.getEvent("set-password")
        .then(event=>{
...
<div>
    <form class="password-form">
        <dl>
            <dt>密码</dt>
            <dd>
                <input type="password" placeholder="密码" class="r-input "  v-model="regForm.password">
            </dd>
        </dl>
<!--        TODO:检查密码强度 仿QQ注册-->
        <dl>
            <dt>确认密码</dt>
            <dd>
                <input type="password" placeholder="密码" class="r-input " v-model="regForm.passwordCheck">
            </dd>
        </dl>
        <dl>
            <dt></dt>
            <dd>
                <button type="button" class="reg-btn" @click="handleRegister">立即注册</button>
            </dd>
        </dl>
    </form>
</div>
